...
public class QuickSettingsController {
    ...
    void loadTiles() {
        ...
        for (String tile : tiles.split("\\|")) {
            ...
            } else if (tile.equals(TILE_CROM)) {
                qs = new CromTile(mContext, this);
            ...
            } else if (tile.equals(TILE_EXPDESKTOP)) {
                qs = new ExpandedDesktopTile(mContext, this, mHandler);
            } else if (tile.equals(TILE_TRDS)) {
                qs = new TRDSTile(mContext, this, mHandler);
